...
//mult(4, 3) => {
//console.log('The answer is ' + result) //should console.log 12
//})
...
const first = (array, callback) => firstName(array);
  const firstName = (array) => array[0]
   
const result2 = first(names, firstName)

console.log(result2)

// Jerrell's solution:
// const first = (array,callBack) => callBack(array);
// const back = (array) => array[0];
// console.log(first(names,back));
...
const last = (array, callback) => lastName(array);
  const lastName = (array) => array[array.length - 1]
   
const result3 = last(names, lastName)
